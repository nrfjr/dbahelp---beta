                    ...
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable absolute pointer-events-none w-1/3 top-1/3 left-1/3">
                      <div class=" modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                        ...
                        <div class="modal-body relative p-4">
                          ...
                          <input id="db" name="db" value="<?php echo $titles[$count] == 'OFIN' ? $titles[$count] . 'DB' : $titles[$count] . 'PRD'; ?>" class="hidden">
                          <input id="size" name="size" class="ml-4 bg-gray-400 text-black" placeholder="number only" type="number">
                        </div>
