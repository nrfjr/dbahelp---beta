      ...
      <div class="grid grid-cols-3 lg:grid-cols-2 place-center gap-2">
        ...
        <div class="">
          <div class="sm-card h-full grid grid-cols-1 flex justify-start gap-2 text-left">
                    ...
                    <div class=" modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                      ...
                      <div class="modal-footer flex flex-shrink-0 flex-wrap items-center justify-end p-4 border-t border-gray-200 rounded-b-md">
                        <form action="" method="POST">
                          <button type="button" class="inline-flex w-full justify-center rounded-md border border-transparent bg-green-700 px-4 py-2 text-base font-medium text-white shadow-sm focus:outline-none focus:ring-2  focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm">Apply</button>
                        </form>
            ...
            <div>
              <a href="<?php echo URLROOT; ?>/flashrecoveryareas/logswitch/<?php echo $titles[$count]; ?>"><button class="rounded-lg w-full lg:w-1/2 xl:w-full 2xl:w-1/2 bg-gray-100 hover:bg-gray-500 border-1 border-solid border-gray-900 text-center px-4 py-2">Log Switches</button></a>
            </div>
          </div>
        </div>
      </div>
