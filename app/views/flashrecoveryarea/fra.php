          ...
          <div class="grid grid-cols-3 lg:grid-cols-2 place-center gap-2">
            ...
            <div class="z-10">
              <div class="sm-card h-full grid grid-cols-1 flex justify-start gap-2 text-left">
                ...
                <div>
                  <form action="<?php echo URLROOT; ?>/flashrecoveryareas/resize">
                  <button class="rounded-lg w-full lg:w-1/2 xl:w-full 2xl:w-1/2 bg-gray-100 hover:bg-gray-500 border-1 border-solid border-gray-900 text-center px-4 py-2">
                    Resize RFA
                  </button>
    </form>
                </div>
