...
require_once APPROOT . '/controllers/homepage.php';  
?>
<?php require APPROOT . '/views/inc/sidebar.php'; ?>
    ...
    <div class="grid grid-cols-4 gap-4 ">
      ...
      <div class="w-2/7 bg-gray-600 p-5 rounded-lg mb-2">
          ...
          while (i < count) {
            var x = baseval;
            var y = returnsession()//Math.floor(Math.random() * (yrange.max - yrange.min + 1)) + yrange.min; //this one is the initial value for Y
          ...
          data.push({
            x: newDate,
            y: returnsession()//Math.floor(Math.random() * (yrange.max - yrange.min + 1)) + yrange.min //this where Y axis and updating can be control
          })
          }

          function returnsession(){
            return <?php echo $this->getUserSessions(); ?>;
          }
