...
<div class="flex justify-between mb-5">
    <h1 class="text-3xl text-black text-white">
        <a href="<?php echo URLROOT; ?>/homepages/index/<?php echo $_SESSION['ObjectDB']; ?>" class="no-underline hover:underline">Objects</a> > <b>Invalid Objects</b>
    </h1>
    <a href="<?php echo URLROOT; ?>/objects/invalidobjects/<?php echo $_SESSION['ObjectDB'] ?>"><button class="px-4 py-2 rounded-lg bg-gray-200 hover:bg-gray-500"> Refresh
    ...
    <div style="height: auto; overflow: clip;" class="">
        <div class="block  justify-center w-full shadow-md overflow-auto sm:rounded-lg" style="max-height: 75vh;">
            ...
            if (!empty($invalidobj)) {
                ...
                foreach ($invalidobj as $outer_key => $array) {
            ...
            ?>
                <table class="w-full text-sm text-center text-white dark:text-gray-400">
                    ...
                    <tbody class="bg-gray-500">
                        <?php
                        foreach ($invalidobj as $column_title => $value) {
                        ?>
