            ...
            ?>
                <table class=" sortable w-full text-sm text-left text-white ">
                    ...
                    <tbody class="bg-gray-500">
                        <?php
                        $lockedsessions = array_slice($lockedsessions, $offset, $limit);
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable relative pointer-events-none w-auto">
                                                    ...
                                                    <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding rounded-md outline-none text-current">
                                                        ...
                                                        <div class="modal-body relative p-4">
                                                            <font color="black">Are you sure to kill Session <b><?php echo $value['SID'] ?></b>?</font>
                                                        </div>
                                                        <div class="modal-footer flex flex-shrink-0 flex-wrap items-center justify-end p-4 border-t border-gray-200 rounded-b-md">
                                                            <form action="<?php echo URLROOT; ?>/monitors/kill/<?php echo $_SESSION['MonitorDB']; ?>" method="POST">
