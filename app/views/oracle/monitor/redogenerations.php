...
<div class="flex flex-col justify-between h-fit gap-y-1 rounded-xl" style="max-height:93%;">
    ...
    <div style="overflow:clip;height: fit-content;" class="rounded-lg">
        <div class="block justify-center lg:h-full w-full shadow-md overflow-auto lg:max-h-80 xl:max-h-96" >
            <?php
            ...
            ?>
                <table class=" sortable w-full text-sm text-center text-white rounded-lg">
                    <thead class="cursor-pointer text-md text-black bg-indigo-200 sticky top-0 rounded-t-lg">
                        <tr>
