...
<div class="relative">
  ...
  <div id="redologPMZoom" class="hidden absolute flex rounded-md bg-white bg-opacity-25 w-full h-full z-20 top-0 left-0 justify-center items-center p-4 xl:p-36 backdrop-filter backdrop-blur-sm">
