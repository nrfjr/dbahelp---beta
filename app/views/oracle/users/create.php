        ...
        <form name="Create User" action="<?php echo URLROOT; ?>/users/create/<?php echo $_SESSION['CreateUserDB']; ?>" method="POST">
          <div class="bg-white px-4 py-5 sm:p-6">
            ...
            <div>
              ...
              <div class="mt-1">
                <textarea id="remarks" autocomplete="on" name="remarks" rows="3" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm h-30" placeholder="Enter Remarks"><?php echo $data != null ? $data['Remarks'] : ''; ?></textarea>
              </div>
