...
<div class="mt-10 sm:mt-0">
  <div class="xl:grid xl:grid-cols-3 xl:gap-6">
    ...
    <div class="mt-5 xl:col-span-2 md:mt-0 justify-evenly">
      <div class="bg-white overflow-hidden shadow rounded-md pb-44 relative">
...
<!-- Create User Modal -->
<div x-show="toSubmit" class="absolute w-full h-full left-0 top-0 z-10 " aria-labelledby="modal-title" role="dialog" aria-modal="true">
                  <div class="flex fixed w-full h-full inset-0 bg-gray-500 bg-opacity-75 transition-opacity border-4"></div>
                  <div class="modal fade absolute flex justify-center items-center xl:px-36 w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="ModalCenteredScrollable" tabindex="-1" aria-labelledby="ModalCenteredScrollable" aria-modal="true" role="dialog">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable static pointer-events-none w-full xl:w-1/2">
