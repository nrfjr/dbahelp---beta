...
<div class="flex justify-between mb-5">
    ...
    <a href="<?php echo URLROOT; ?>/performances/buffercacheadvisor/<?php echo $_SESSION['PerformanceDB'] ?>"><button class="px-4 py-2 rounded-lg bg-gray-200 hover:bg-gray-500"> Refresh
