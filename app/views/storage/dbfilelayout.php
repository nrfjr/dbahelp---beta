    ...
    <div class=" border-b border-gray-200 dark:border-gray-700">
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center bg-gray-200 rounded-t-lg" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
            <li class="mr-2" role="presentation">
                <a href="?tab=1"><button class="inline-block p-4 rounded-t-lg border-b-2 hover:bg-gray-400" id="datafiles-tab" data-tabs-target="#datafiles" type="button" role="tab" aria-controls="datafiles" aria-selected="<?php echo setSelectTabforHTML(1, $current_tab) ?>">Data Files Location</button></a>
            </li>
            <li class="mr-2" role="presentation">
                <a href="?tab=2"><button class="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:bg-gray-400 hover:border-gray-300 dark:hover:text-gray-300" id="logfiles-tab" data-tabs-target="#logfiles" type="button" role="tab" aria-controls="logfiles" aria-selected="<?php echo setSelectTabforHTML(2, $current_tab) ?>">Redo Log Files Location</button></a>
            </li>
            <li class="mr-2" role="presentation">
