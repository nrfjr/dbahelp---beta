          ...
          <div class="bg-white px-4 py-5 sm:p-6">
            <div class="grid mt-10 grid-cols-6 gap-16 border">
              ...
              <div class="col-span-6 sm:col-span-2">
                ...
                <input type="text" name="middle-name" id="middle-name" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="<?php echo $data!=null? $data['Middlename']:'';?>">
              </div>

              <div class="col-span-6 sm:col-span-2">
                <label for="last-name" class="block text-sm font-medium text-gray-700">Lastname</label>
                <input type="text" name="last-name" id="last-name" autocomplete="family-name" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm " placeholder="Doe" value="<?php echo $data!=null? $data['Lastname']:'';?>">
              </div>

              <div class="col-span-6 sm:col-span-2">
                <label for="Id" class="block text-sm font-medium text-gray-700">Employee ID</label>
                <input type="number" name="Id" id="Id" autocomplete="Id" class="mt-1 block w-64 rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm " placeholder="1234567890" value="<?php echo $data!=null? $data['User Id']:'';?>">
              </div>

              <div class="col-span-6 sm:col-span-2">
                <label for="requestor" class="block text-sm font-medium text-gray-700">Requested By</label>
                <input type="text" name="requestor" id="requestor" autocomplete="requestor" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm " placeholder="John Doe" value="<?php echo $data!=null? $data['Requestor']:'';?>">
              </div>

              <div class="col-span-6 sm:col-span-2">
                <label for="same-access" class="block text-sm font-medium text-gray-700">Same Access (Optional)</label>
                <input type="text" name="same-access" id="same-access" class="mt-1 block w-full rounded-md border-gray-300 bg-gray-100 p-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="<?php echo $data!=null? $data['Sameaccess']:'';?>">
              </div>
            ...
            <div class="">
              ...
              <div class="mt-1 ">
                <input type="text" id="remarks" autocomplete="remarks" name="remarks" rows="3" class="p-2 mt-1 block w-full rounded-md border-gray-300 bg-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm " placeholder="Enter Remarks"><?php echo $data!=null? $data['Remarks']:'';?></input>
              </div>
